...
sudo -i -u postgres psql -d greenlight -c "GRANT USAGE ON SCHEMA public TO greenlight"
sudo -i -u postgres psql -d greenlight -c "GRANT CREATE ON SCHEMA public TO greenlight;
"
